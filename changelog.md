...
------------------------------------------------------
Arsenal 0.1.5 - 1.21.1
------------------------------------------------------
- Full Port to 1.21.1 using existing 1.21.1 version of ratatoullie
- Fixed the Anchorblade Reeling enchantment recall not working
- Added right-click recall for the Reeling Anchorblade after 5 ticks in the ground
- Fixed the Shockwave particle not appearing on Anchorblade landing
- Fixed the creative mode back slot being non-functional
- Reduced Shockwave particle opacity by 30%
